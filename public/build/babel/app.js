...
function applyStaticTranslations() {
  ...
  var locationSelect = document.querySelector("#productLocations option[value='none']");
  var sortNewest = document.querySelector("#sort option[value='newest']");
  var sortOldest = document.querySelector("#sort option[value='oldest']");
...
function setupLanguageToggle() {
  var englishButton = document.querySelector("#englishLanguageBtn");
  var chineseButton = document.querySelector("#chineseLanguageBtn");
  if (!englishButton || !chineseButton) {
    return;
  }
  function updateLanguageButtons() {
    var currentLanguage = getCurrentLanguage();
    var activeClass = "px-3 py-2 bg-green-600 text-main rounded-lg font-semibold";
    var inactiveClass = "px-3 py-2 border-2 border-green-600 text-green-600 rounded-lg font-semibold";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var productView = new _productView["default"](i18n);
  var categoryView = new _categoryView["default"](i18n);
